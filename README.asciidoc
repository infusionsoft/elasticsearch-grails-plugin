...
=== How can I publish the plugin?

Add entries in your settings.groovy:

----
grails.project.repos.'external-artifacts'.username = "your username"
grails.project.repos.'external-artifacts'.password = "your API token"
----

Then run `grailsw maven-deploy`.  If you get access denied, make sure you have deploy permissions on artifactory.
